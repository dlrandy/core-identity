...
namespace IdentityManager.Controllers
{
	public class UserController :Controller
	{
		...
		public async Task<IActionResult> ManageRole(string userId)
		{
			...
			List<string> existingUserRoels = (List<string>)await _userManager.GetRolesAsync(user);
			...
			{
				RolesSelection roleSelection = new RolesSelection() {
					RoleName = role.Name
				};
				if (existingUserRoels.Any(c => c == role.Name))
				{
